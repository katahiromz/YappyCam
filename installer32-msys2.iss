...
OutputBaseFilename=YappyCam32-0.9.3-setup
Compression=lzma
...
Source: "..\msys2\x86\libHalf-2_5.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x86\libIex-2_5.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x86\libIlmImf-2_5.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x86\libIlmThread-2_5.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x86\libImath-2_5.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\msys2\x86\libopencv_calib3d451.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x86\libopencv_core451.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x86\libopencv_features2d451.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x86\libopencv_flann451.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x86\libopencv_imgcodecs451.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x86\libopencv_imgproc451.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x86\libopencv_objdetect451.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x86\libopencv_videoio451.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x86\libopenjp2-7.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\msys2\x86\opencv_videoio_ffmpeg451.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\msys2\x86\libdeflate.dll"; DestDir: "{app}"; Flags: ignoreversion
