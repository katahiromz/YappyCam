...
Source: "..\msys2\x64\libHalf-2_5.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x64\libIex-2_5.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x64\libIlmImf-2_5.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x64\libIlmThread-2_5.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x64\libImath-2_5.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x64\libdeflate.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\msys2\x64\libopencv_calib3d451.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x64\libopencv_core451.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x64\libopencv_features2d451.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x64\libopencv_flann451.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x64\libopencv_imgcodecs451.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x64\libopencv_imgproc451.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x64\libopencv_objdetect451.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x64\libopencv_videoio451.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\msys2\x64\libopenjp2-7.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\msys2\x64\opencv_videoio_ffmpeg451_64.dll"; DestDir: "{app}"; Flags: ignoreversion
